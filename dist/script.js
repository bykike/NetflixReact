...
var Logo = React.createClass({ displayName: "Logo",
  render: function () {
    return (
      ...
      React.createElement("svg", { version: "1.1", width: "300", height: "81.386726", id: "svg3262" },
      React.createElement("g", { transform: "translate(-384.28572,-428.81172)", id: "layer1" },
      React.createElement("g", { transform: "matrix(2.5445375,0,0,2.5445375,1157.1714,-1457.8678)", id: "g3235" },
...
var UserProfile = React.createClass({ displayName: "UserProfile",
  render: function () {
    return (
      ...
      React.createElement("div", { className: "name" }, "Jack Oliver"),
      React.createElement("div", { className: "image" }, React.createElement("img", { src: "https://s3-us-west-2.amazonaws.com/s.cdpn.io/557257/profile/profile-512_1.jpg" }))),
      ...
      React.createElement("div", { className: "UserNavigation" },
      React.createElement("ul", null,
      React.createElement("li", null, "Your Account"),
      React.createElement("li", null, "Help Center"),
      React.createElement("li", null, "Sign out of Netflix"))))));
...
var Hero = React.createClass({ displayName: "Hero",
  render: function () {
    return (
      React.createElement("div", { id: "hero", className: "Hero", style: { backgroundImage: 'url(https://images.alphacoders.com/633/633643.jpg)' } },
      React.createElement("div", { className: "content" },
      React.createElement("img", { className: "logo", src: "http://www.returndates.com/backgrounds/narcos.logo.png", alt: "" }),
      React.createElement("h2", null, "Season 2 now available"),
      React.createElement("p", null, "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloremque id quam sapiente unde voluptatum alias vero debitis, magnam quis quod."),
...
// Hero Button
var HeroButton = React.createClass({ displayName: "HeroButton",
  render: function () {
    return (
      React.createElement("a", { href: "#", className: "Button", "data-primary": this.props.primary }, this.props.text));
...
var TitleList = React.createClass({ displayName: "TitleList",
  ...
  render: function () {
    ...
    return (
      React.createElement("div", { ref: "titlecategory", className: "TitleList", "data-loaded": this.state.mounted },
...
var Item = React.createClass({ displayName: "Item",
  render: function () {
    return (
      React.createElement("div", { className: "Item", style: { backgroundImage: 'url(' + this.props.backdrop + ')' } },
      React.createElement("div", { className: "overlay" },
      React.createElement("div", { className: "title" }, this.props.title),
      React.createElement("div", { className: "rating" }, this.props.score, " / 10"),
      React.createElement("div", { className: "plot" }, this.props.overview),
...
var ListToggle = React.createClass({ displayName: "ListToggle",
  ...
  render: function () {
    return (
      React.createElement("div", { onClick: this.handleClick, "data-toggled": this.state.toggled, className: "ListToggle" },
      React.createElement("div", null,
